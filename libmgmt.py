    ...
    while (True):
        ...
        try:
            ...
            if usr_response == 1:  # listing
                Mumbailibrary.displayAvailableBooks()
            elif usr_response == 2:  # borrow
                Mumbailibrary.borrowBook(
                    input("Enter your name: "), student.requestBook())
            elif usr_response == 3:  # return
                Mumbailibrary.returnBook(student.returnBook())
            elif usr_response == 4:  # donate
                Mumbailibrary.donateBook(student.donateBook())
